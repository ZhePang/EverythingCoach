...
class PopupStoreChannel {
  ...
  themeChangedChannel() {
    const walletAccountImportChannel = new broadcast_channel_namespaceObject.BroadcastChannel("".concat(enums/* BROADCAST_CHANNELS.THEME_CHANGE */.kl.THEME_CHANGE, "_").concat(this.instanceId), utils/* broadcastChannelOptions */.aN);
    walletAccountImportChannel.addEventListener("message", ev => {
      var _ev$data6;
