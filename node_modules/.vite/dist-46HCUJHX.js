import {
  ...
  require_sha
} from "./chunk-2W6ANCHA.js";
import {
  require_react_dom
} from "./chunk-YADXM6CU.js";
import {
  require_prop_types
} from "./chunk-FCGT65GX.js";
import {
  require_assert
} from "./chunk-YPZTZ7QK.js";
import {
  require_events
  ...
  "node_modules/bs58check/base.js"(exports, module) {
    ...
    module.exports = function(checksumFn) {
      function encode(payload) {
        ...
        return base58.encode(Buffer14.concat([
          payload,
          checksum
        ], payload.length + 4));
      }
...
var require_buffer = __commonJS({
  "node_modules/crc/node_modules/buffer/index.js"(exports) {
    ...
    Buffer14.concat = function concat2(list, length) {
...
var init_crc32 = __esm({
  "node_modules/crc/crc32.js"() {
    init_define_process_env();
    import_buffer11 = __toModule(require_buffer());
    init_create_buffer();
    init_define_crc();
    TABLE8 = [
      0,
...
var init_crcjam = __esm({
  "node_modules/crc/crcjam.js"() {
    init_define_process_env();
    import_buffer12 = __toModule(require_buffer());
    init_create_buffer();
    init_define_crc();
    TABLE9 = [
      0,
...
var require_utils2 = __commonJS({
  "node_modules/@ngraveio/bc-ur/dist/utils.js"(exports) {
    ...
    var crc_1 = (init_crc(), crc_exports);
    var sha256Hash = (data) => sha_js_1.default("sha256").update(data).digest();
    exports.sha256Hash = sha256Hash;
    var partition2 = (s, n) => s.match(new RegExp(".{1," + n + "}", "g")) || [s];
...
var require_xoshiro = __commonJS({
  "node_modules/@ngraveio/bc-ur/dist/xoshiro.js"(exports) {
    ...
    var jsbi_1 = __importDefault((init_jsbi(), jsbi_exports));
    ...
    var CryptoCoinInfo = class extends RegistryItem_1.RegistryItem {
      constructor(type, network) {
        ...
        this.toDataItem = () => {
          const map2 = {};
          if (this.type) {
            map2[Keys.type] = this.type;
          }
          if (this.network) {
            map2[Keys.network] = this.network;
          }
          return new lib_1.DataItem(map2);
        };
      }
    };
    exports.CryptoCoinInfo = CryptoCoinInfo;
    CryptoCoinInfo.fromDataItem = (dataItem) => {
      const map2 = dataItem.getData();
      const type = map2[Keys.type];
      const network = map2[Keys.network];
...
var require_CryptoKeypath = __commonJS({
  "node_modules/@keystonehq/bc-ur-registry/dist/CryptoKeypath.js"(exports) {
    ...
    var CryptoKeypath = class extends RegistryItem_1.RegistryItem {
      constructor(components = [], sourceFingerprint, depth) {
        ...
        this.toDataItem = () => {
          ...
          map2[Keys.components] = components2;
          if (this.sourceFingerprint) {
            map2[Keys.source_fingerprint] = this.sourceFingerprint.readUInt32BE(0);
          }
          if (this.depth !== void 0) {
            map2[Keys.depth] = this.depth;
          }
          return new lib_1.DataItem(map2);
        };
      }
    ...
    CryptoKeypath.fromDataItem = (dataItem) => {
      ...
      const components = map2[Keys.components];
      if (components) {
...
var require_CryptoHDKey = __commonJS({
  "node_modules/@keystonehq/bc-ur-registry/dist/CryptoHDKey.js"(exports) {
    ...
    var CryptoHDKey = class extends RegistryItem_1.RegistryItem {
      constructor(args) {
        ...
        this.toDataItem = () => {
          const map2 = {};
          if (this.master) {
            map2[Keys.is_master] = true;
            map2[Keys.key_data] = this.key;
            map2[Keys.chain_code] = this.chainCode;
          } else {
            if (this.privateKey !== void 0) {
              map2[Keys.is_private] = this.privateKey;
            }
            map2[Keys.key_data] = this.key;
            if (this.chainCode) {
              map2[Keys.chain_code] = this.chainCode;
            ...
            if (this.useInfo) {
              ...
              map2[Keys.use_info] = useInfo;
            }
            if (this.origin) {
              const origin = this.origin.toDataItem();
              origin.setTag(this.origin.getRegistryType().getTag());
              map2[Keys.origin] = origin;
            }
            if (this.children) {
              const children = this.children.toDataItem();
              children.setTag(this.children.getRegistryType().getTag());
              map2[Keys.children] = children;
            }
            if (this.parentFingerprint) {
              map2[Keys.parent_fingerprint] = this.parentFingerprint.readUInt32BE(0);
            }
            if (this.name !== void 0) {
              map2[Keys.name] = this.name;
            }
            if (this.note !== void 0) {
              map2[Keys.note] = this.note;
            }
          }
          return new lib_1.DataItem(map2);
        };
    ...
    CryptoHDKey.fromDataItem = (dataItem) => {
      const map2 = dataItem.getData();
      const isMaster = !!map2[Keys.is_master];
      const isPrivateKey = map2[Keys.is_private];
      const key = map2[Keys.key_data];
      const chainCode = map2[Keys.chain_code];
      const useInfo = map2[Keys.use_info] ? CryptoCoinInfo_1.CryptoCoinInfo.fromDataItem(map2[Keys.use_info]) : void 0;
      const origin = map2[Keys.origin] ? CryptoKeypath_1.CryptoKeypath.fromDataItem(map2[Keys.origin]) : void 0;
      const children = map2[Keys.children] ? CryptoKeypath_1.CryptoKeypath.fromDataItem(map2[Keys.children]) : void 0;
      const _parentFingerprint = map2[Keys.parent_fingerprint];
      ...
      const name = map2[Keys.name];
      const note = map2[Keys.note];
...
var require_CryptoECKey = __commonJS({
  "node_modules/@keystonehq/bc-ur-registry/dist/CryptoECKey.js"(exports) {
    ...
    var CryptoECKey = class extends RegistryItem_1.RegistryItem {
      constructor(args) {
        ...
        this.toDataItem = () => {
          const map2 = {};
          if (this.curve) {
            map2[Keys.curve] = this.curve;
          }
          if (this.privateKey !== void 0) {
            map2[Keys.private] = this.privateKey;
          }
          map2[Keys.data] = this.data;
          return new lib_1.DataItem(map2);
        };
        this.getOutputDescriptorContent = () => {
    ...
    CryptoECKey.fromDataItem = (dataItem) => {
      const map2 = dataItem.getData();
      const curve = map2[Keys.curve];
      const privateKey = map2[Keys.private];
      const data = map2[Keys.data];
      if (!data) {
  ...
  "node_modules/@keystonehq/bc-ur-registry/dist/MultiKey.js"(exports) {
    ...
    var MultiKey = class extends RegistryItem_1.RegistryItem {
      constructor(threshold, keys) {
        ...
        this.toDataItem = () => {
          const map2 = {};
          map2[Keys.threshold] = this.threshold;
          const keys2 = this.keys.map((k) => {
            const dataItem = k.toDataItem();
            dataItem.setTag(k.getRegistryType().getTag());
            return dataItem;
          });
          map2[Keys.keys] = keys2;
          return new DataItem_1.DataItem(map2);
        };
        this.getOutputDescriptorContent = () => {
          return [
            this.getThreshold(),
    ...
    MultiKey.fromDataItem = (dataItem) => {
      const map2 = dataItem.getData();
      const threshold = map2[Keys.threshold];
      const _keys = map2[Keys.keys];
      const keys = [];
      _keys.forEach((k) => {
...
var require_CryptoAccount = __commonJS({
  "node_modules/@keystonehq/bc-ur-registry/dist/CryptoAccount.js"(exports) {
      ...
      constructor(masterFingerprint, outputDescriptors) {
        ...
        this.toDataItem = () => {
          ...
          if (this.masterFingerprint) {
            map2[Keys.masterFingerprint] = this.masterFingerprint.readUInt32BE(0);
          }
          if (this.outputDescriptors) {
            map2[Keys.outputDescriptors] = this.outputDescriptors.map((item) => item.toDataItem());
          }
          return new lib_1.DataItem(map2);
        };
      }
    ...
    CryptoAccount.fromDataItem = (dataItem) => {
      ...
      const _masterFingerprint = map2[Keys.masterFingerprint];
      if (_masterFingerprint) {
        masterFingerprint.writeUInt32BE(_masterFingerprint, 0);
      }
      const outputDescriptors = map2[Keys.outputDescriptors];
...
// node_modules/@keystonehq/bc-ur-registry/dist/errors/index.js
var require_errors2 = __commonJS({
  "node_modules/@keystonehq/bc-ur-registry/dist/errors/index.js"(exports) {
    init_define_process_env();
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.UnknownURTypeError = void 0;
    var UnknownURTypeError = class extends Error {
      constructor(message) {
        super(message);
      }
    };
...
// node_modules/@keystonehq/bc-ur-registry/dist/extended/CryptoMultiAccounts.js
var require_CryptoMultiAccounts = __commonJS({
  "node_modules/@keystonehq/bc-ur-registry/dist/extended/CryptoMultiAccounts.js"(exports) {
    init_define_process_env();
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var CryptoMultiAccounts = class extends RegistryItem_1.RegistryItem {
      constructor(masterFingerprint, keys, device) {
        ...
        this.toDataItem = () => {
          ...
          if (this.keys) {
            map2[Keys.keys] = this.keys.map((item) => {
...
var require_types = __commonJS({
  "node_modules/@keystonehq/bc-ur-registry/dist/types.js"(exports) {
    init_define_process_env();
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
  }
...
var require_dist2 = __commonJS({
  "node_modules/@keystonehq/bc-ur-registry/dist/index.js"(exports) {
    ...
    var utils_1 = require_utils();
    var CryptoMultiAccounts_1 = require_CryptoMultiAccounts();
    ...
    (0, tslib_130.__exportStar)(require_errors2(), exports);
    (0, tslib_130.__exportStar)(require_Decoder(), exports);
    (0, tslib_130.__exportStar)(require_lib(), exports);
    (0, tslib_130.__exportStar)(require_CryptoAccount(), exports);
    (0, tslib_130.__exportStar)(require_CryptoPSBT(), exports);
    (0, tslib_130.__exportStar)(require_CryptoHDKey(), exports);
    (0, tslib_130.__exportStar)(require_CryptoMultiAccounts(), exports);
    (0, tslib_130.__exportStar)(require_CryptoOutput(), exports);
    (0, tslib_130.__exportStar)(require_CryptoCoinInfo(), exports);
    (0, tslib_130.__exportStar)(require_CryptoECKey(), exports);
    (0, tslib_130.__exportStar)(require_MultiKey(), exports);
    (0, tslib_130.__exportStar)(require_CryptoKeypath(), exports);
    (0, tslib_130.__exportStar)(require_patchCBOR(), exports);
    (0, tslib_130.__exportStar)(require_PathComponent(), exports);
    (0, tslib_130.__exportStar)(require_RegistryItem(), exports);
    (0, tslib_130.__exportStar)(require_RegistryType(), exports);
    (0, tslib_130.__exportStar)(require_types(), exports);
    (0, tslib_130.__exportStar)(require_utils(), exports);
    exports.default = URlib;
  }
});

// node_modules/@keystonehq/bc-ur-registry-sol/dist/bc-ur-registry-sol.cjs.development.js
var require_bc_ur_registry_sol_cjs_development = __commonJS({
  "node_modules/@keystonehq/bc-ur-registry-sol/dist/bc-ur-registry-sol.cjs.development.js"(exports) {
    init_define_process_env();
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var bcUrRegistry = require_dist2();
    var uuid = (init_esm_browser(), esm_browser_exports);
    var ExtendedRegistryTypes = {
      SOL_SIGN_REQUEST: new bcUrRegistry.RegistryType("sol-sign-request", 1101),
      SOL_SIGNATURE: new bcUrRegistry.RegistryType("sol-signature", 1102),
      SOL_NFT_ITEM: new bcUrRegistry.RegistryType("sol-nft-item", 1104)
    };
    var {
      decodeToDataItem,
      RegistryTypes
    ...
    (function(Keys2) {
      ...
      Keys2[Keys2["derivationPath"] = 3] = "derivationPath";
      Keys2[Keys2["address"] = 4] = "address";
      Keys2[Keys2["origin"] = 5] = "origin";
      Keys2[Keys2["signType"] = 6] = "signType";
    })(Keys || (Keys = {}));
    var SolSignRequest = class extends bcUrRegistry.RegistryItem {
      constructor(args) {
        super();
        ...
        this.toDataItem = () => {
          const map2 = {};
          if (this.requestId) {
            map2[Keys.requestId] = new bcUrRegistry.DataItem(this.requestId, RegistryTypes.UUID.getTag());
          }
          if (this.address) {
            map2[Keys.address] = this.address;
          }
          if (this.origin) {
            map2[Keys.origin] = this.origin;
          }
          map2[Keys.signData] = this.signData;
          map2[Keys.signType] = this.signType;
          const keyPath = this.derivationPath.toDataItem();
          keyPath.setTag(this.derivationPath.getRegistryType().getTag());
          map2[Keys.derivationPath] = keyPath;
          return new bcUrRegistry.DataItem(map2);
        };
    ...
    SolSignRequest.fromDataItem = (dataItem) => {
      const map2 = dataItem.getData();
      const signData = map2[Keys.signData];
      const derivationPath = bcUrRegistry.CryptoKeypath.fromDataItem(map2[Keys.derivationPath]);
      const address = map2[Keys.address] ? map2[Keys.address] : void 0;
      const requestId = map2[Keys.requestId] ? map2[Keys.requestId].getData() : void 0;
      const origin = map2[Keys.origin] ? map2[Keys.origin] : void 0;
      const signType = map2[Keys.signType];
      return new SolSignRequest({
        requestId,
        signData,
        derivationPath,
    ...
    var SolSignature = class extends bcUrRegistry.RegistryItem {
      constructor(signature, requestId) {
        ...
        this.toDataItem = () => {
          const map2 = {};
          if (this.requestId) {
            map2[Keys$1.requestId] = new bcUrRegistry.DataItem(this.requestId, RegistryTypes$1.UUID.getTag());
          }
          map2[Keys$1.signature] = this.signature;
          return new bcUrRegistry.DataItem(map2);
        };
    ...
    SolSignature.fromDataItem = (dataItem) => {
      const map2 = dataItem.getData();
      const signature = map2[Keys$1.signature];
      const requestId = map2[Keys$1.requestId] ? map2[Keys$1.requestId].getData() : void 0;
    ...
    var Keys$2;
    (function(Keys2) {
      Keys2[Keys2["mintAddress"] = 1] = "mintAddress";
      Keys2[Keys2["collectionName"] = 2] = "collectionName";
      Keys2[Keys2["name"] = 3] = "name";
      Keys2[Keys2["mediaData"] = 4] = "mediaData";
    })(Keys$2 || (Keys$2 = {}));
    var SOLNFTItem = class extends bcUrRegistry.RegistryItem {
      constructor(args) {
        super();
        ...
        this.toDataItem = () => {
          const map2 = {};
          map2[Keys$2.name] = this.name;
          map2[Keys$2.mintAddress] = this.mintAddress;
          map2[Keys$2.collectionName] = this.collectionName;
          map2[Keys$2.mediaData] = this.mediaData;
          return new bcUrRegistry.DataItem(map2);
        };
        this.name = args.name;
        this.mintAddress = args.mintAddress;
        this.collectionName = args.collectionName;
        this.mediaData = args.mediaData;
      }
    ...
    SOLNFTItem.fromDataItem = (dataItem) => {
      const map2 = dataItem.getData();
      const name = map2[Keys$2.name];
      const mediaData = map2[Keys$2.mediaData];
      const mintAddress = map2[Keys$2.mintAddress];
      const collectionName = map2[Keys$2.collectionName];
      return new SOLNFTItem({
        name,
        mintAddress,
        collectionName,
...
// node_modules/@keystonehq/bc-ur-registry-sol/dist/index.js
var require_dist3 = __commonJS({
  "node_modules/@keystonehq/bc-ur-registry-sol/dist/index.js"(exports, module) {
    init_define_process_env();
    "use strict";
    if (false) {
      module.exports = null;
    } else {
      module.exports = require_bc_ur_registry_sol_cjs_development();
    }
  }
});
...
var require_rtcpeerconnection = __commonJS({
  "node_modules/rtcpeerconnection-shim/rtcpeerconnection.js"(exports, module) {
    ...
    module.exports = function(window2, edgeVersion) {
      ...
      var RTCPeerConnection = function(config2) {
        var pc = this;
        ...
        this.usingBundle = config2.bundlePolicy === "max-bundle";
        if (config2.rtcpMuxPolicy === "negotiate") {
          throw makeError("NotSupportedError", "rtcpMuxPolicy 'negotiate' is not supported");
        } else if (!config2.rtcpMuxPolicy) {
          config2.rtcpMuxPolicy = "require";
        }
        switch (config2.iceTransportPolicy) {
          case "all":
          case "relay":
            break;
          default:
            config2.iceTransportPolicy = "all";
            break;
        }
        switch (config2.bundlePolicy) {
          case "balanced":
          case "max-compat":
          case "max-bundle":
            break;
          default:
            config2.bundlePolicy = "balanced";
            break;
        }
        config2.iceServers = filterIceServers2(config2.iceServers || [], edgeVersion);
        this._iceGatherers = [];
        if (config2.iceCandidatePoolSize) {
          for (var i = config2.iceCandidatePoolSize; i > 0; i--) {
            this._iceGatherers.push(new window2.RTCIceGatherer({
              iceServers: config2.iceServers,
              gatherPolicy: config2.iceTransportPolicy
            }));
          }
        } else {
          config2.iceCandidatePoolSize = 0;
        }
...
function shimPeerConnection2(window2, browserDetails) {
  ...
  window2.RTCPeerConnection = function RTCPeerConnection(config2) {
    if (config2 && config2.iceServers) {
      config2.iceServers = filterIceServers(config2.iceServers, browserDetails.version);
      log("ICE servers after filtering:", config2.iceServers);
    }
    return new RTCPeerConnectionShim(config2);
  };
...
var init_edge_shim = __esm({
  "node_modules/webrtc-adapter/src/js/edge/edge_shim.js"() {
    ...
    import_rtcpeerconnection_shim = __toModule(require_rtcpeerconnection());
    init_getusermedia2();
...
var init_common_shim = __esm({
  "node_modules/webrtc-adapter/src/js/common_shim.js"() {
    init_define_process_env();
    import_sdp = __toModule(require_sdp());
    init_utils();
    "use strict";
  }
});
...
var require_sdk_cjs_development = __commonJS({
  "node_modules/@keystonehq/sdk/dist/sdk.cjs.development.js"(exports) {
    ...
    var rxjs = (init_esm5(), esm5_exports);
    var QRCode = _interopDefault(require_lib3());
    var bcUr = require_dist();
    var BaseQRCode = ({
      size = 200,
      data = "",
      ecl = "L"
    ...
    var DEFAULT_MAX_FRAGMENT_LENGTH = 400;
        ...
        read: async (expect, options) => {
          return new Promise((resolve) => {
            ...
            if (options.renderInitial) {
              ...
              setMode("initial");
              setVisible(true);
              read2(expect, options).then((result) => {
                reset();
                resolve(result);
              });
            } else {
...
// node_modules/@keystonehq/sol-keyring/node_modules/base-x/src/index.js
var require_src = __commonJS({
  "node_modules/@keystonehq/sol-keyring/node_modules/base-x/src/index.js"(exports, module) {
    init_define_process_env();
    "use strict";
...
// node_modules/@keystonehq/sol-keyring/node_modules/bs58/index.js
var require_bs582 = __commonJS({
  "node_modules/@keystonehq/sol-keyring/node_modules/bs58/index.js"(exports, module) {
    init_define_process_env();
...
// node_modules/@keystonehq/sol-keyring/dist/sol-keyring.cjs.development.js
var require_sol_keyring_cjs_development = __commonJS({
  "node_modules/@keystonehq/sol-keyring/dist/sol-keyring.cjs.development.js"(exports) {
    init_define_process_env();
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    function _interopDefault(ex) {
    ...
    var bcUrRegistrySol = require_dist3();
    var sdk = require_dist4();
    var sdk__default = _interopDefault(sdk);
    var bcUrRegistry = require_dist2();
    var bs58 = _interopDefault(require_bs582());
    var uuid = (init_esm_browser(), esm_browser_exports);
    var web3_js = (init_index_browser_esm(), index_browser_esm_exports);
    ...
    var BaseKeyring = class {
      ...
      async _getSignature(pubKey, messageHex, signType) {
        ...
        const account = this.getAccounts().find((account2) => account2.pubKey == pubKey);
    ...
    var DefaultKeyring = class extends BaseKeyring {
      constructor() {
        super();
        this.getInteraction = () => {
...
var require_dist5 = __commonJS({
  "node_modules/@keystonehq/sol-keyring/dist/index.js"(exports, module) {
    init_define_process_env();
    "use strict";
    if (false) {
      module.exports = null;
    } else {
      module.exports = require_sol_keyring_cjs_development();
    }
  }
});
...
***************************************************************************** */
//# sourceMappingURL=dist-46HCUJHX.js.map
